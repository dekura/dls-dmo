...
@LastEditTime: 2019-11-16 21:03:37
@Contact: cgjhaha@qq.com
@Description: combine combined AB(design_contour), and C(mask)
'''
import os
import numpy as np
import cv2
...
parser.add_argument('--fold_A', dest='fold_A', help='input directory for image A', type=str, default='/Users/dekura/Desktop/opc/datasets/design_mask_contour_ABC_2048/A')
parser.add_argument('--fold_B', dest='fold_B', help='input directory for image B', type=str, default='/Users/dekura/Desktop/opc/datasets/design_mask_contour_ABC_2048/B')
parser.add_argument('--fold_AB', dest='fold_AB', help='output directory', type=str, default='/Users/dekura/Desktop/opc/datasets/design_mask_contour_ABC_2048/combine_AB')
