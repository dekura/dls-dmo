'''
@Author: Guojin Chen
@Date: 2019-11-13 00:52:14
@LastEditTime: 2019-11-14 21:31:36
...
# Outfolder = os.path.join(os.path.abspath(os.path.dirname(__file__)),'test_sample_output/maskg_only')
Outfolder = '/Users/dekura/Desktop/opc/datasets/myresults/maskg_only'
