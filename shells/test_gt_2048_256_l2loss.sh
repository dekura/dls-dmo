...
# @Author: Guojin Chen
 ...
 # @LastEditTime: 2019-11-20 18:20:48
...
--input_nc 3 \
--output_nc 3 \
--dataroot /research/dept7/glchen/datasets/gan_gds2png/dcupp_naive6_100epoch_dr2mg_2048_256_gt \
--results_dir /research/dept7/glchen/github/pixel2pixel/results \
--name dcupp_naive6_100epoch_dr2mg_2048_256_gt_l2loss \
--direction AtoB \
