...
import torchvision
# from .nonlocal import NonLocalATT
from .Non_local import NonLocalATT
...
class NestedUNet_NLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        ...
        self.nl4_0 = NonLocalATT(in_dim = nb_filter[4])
        ...
        # self.non_local = NonLocalATT(in_dim=1, out_channel=256)
    ...
    def forward(self, input):
        ...
        if self.deepsupervision:
            ...
            # final_output = self.non_local((output1 + output2 + output3 + output4)/4)
            final_output = (output1 + output2 + output3 + output4)/4
            return self.tanh(final_output)
            # return [output1, output2, output3, output4]

        else:
            # output = self.tanh(self.non_local(self.final(x0_4)))
            output = self.tanh(self.final(x0_4))
            return output

class NestedUNet_2NLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        """
        :param args:
            input_channels
        ...
        self.up2_0 = UpConv(nb_filter[2])
        self.conv3_0 = VGGBlock(nb_filter[2], nb_filter[3], nb_filter[3])
        self.nl3_0 = NonLocalATT(in_dim = nb_filter[3])
        self.pool3_0 = PoolConv(nb_filter[3])
        self.up3_0 = UpConv(nb_filter[3])
        self.conv4_0 = VGGBlock(nb_filter[3], nb_filter[4], nb_filter[4])
        self.nl4_0 = NonLocalATT(in_dim = nb_filter[4])
...
class NestedUNet_3NLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        """
        :param args:
            input_channels
        ...
        self.up1_0 = UpConv(nb_filter[1])
        self.conv2_0 = VGGBlock(nb_filter[1], nb_filter[2], nb_filter[2])
        self.nl2_0 = NonLocalATT(in_dim = nb_filter[2])
        self.pool2_0 = PoolConv(nb_filter[2])
        self.up2_0 = UpConv(nb_filter[2])
        self.conv3_0 = VGGBlock(nb_filter[2], nb_filter[3], nb_filter[3])
        self.nl3_0 = NonLocalATT(in_dim = nb_filter[3])
...
class NestedUNet_4NLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        """
        :param args:
            input_channels
        ...
        self.pool0_0 = PoolConv(nb_filter[0])
        self.conv1_0 = VGGBlock(nb_filter[0], nb_filter[1], nb_filter[1])
        self.nl1_0 = NonLocalATT(in_dim = nb_filter[1])
        self.pool1_0 = PoolConv(nb_filter[1])
        self.up1_0 = UpConv(nb_filter[1])
        self.conv2_0 = VGGBlock(nb_filter[1], nb_filter[2], nb_filter[2])
        self.nl2_0 = NonLocalATT(in_dim = nb_filter[2])
...
class NestedUNet_5NLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        """
        :param args:
            input_channels
        ...
        self.conv0_4 = VGGBlock(nb_filter[0]*4+nb_filter[1], nb_filter[0], nb_filter[0])
        self.non_local = NonLocalATT(in_dim = 1, out_channel = 1)
    ...
    def forward(self, input):
        ...
        if self.deepsupervision:
            output1 = self.non_local(self.final1(x0_1))
            output2 = self.non_local(self.final2(x0_2))
            output3 = self.non_local(self.final3(x0_3))
            output4 = self.non_local(self.final4(x0_4))
            final_output = self.non_local((output1 + output2 + output3 + output4)/4)
            return self.tanh(final_output)
            # return [output1, output2, output3, output4]
...
class NestedUNet_UPNLC(nn.Module):
    def __init__(self, input_nc, deepsupervision=True, upp_scale=2):
        """
        :param args:
            input_channels
        ...
        self.conv0_4 = VGGBlock(nb_filter[0]*4+nb_filter[1], nb_filter[0], nb_filter[0])
        self.nl0_4 = NonLocalATT(in_dim = nb_filter[0])
        # self.non_local = NonLocalATT(in_dim=1, out_channel=256)
